...
class CustomWebBrowser(QMainWindow):
    ...
    def __init__(self, whitelist=[homepage_path, 'http://www.neopets.com/', 'http://www.coolmathgames.com/', 'http://www.ixl.com/', 'http://mail.google.com/'], url=homepage_path):
        ...
        self.setFixedSize(1350, 1080)  # Increase window size by 1/4th
    ...
    def open_chat_history(self):
        with open("chat-history.txt", "r") as chat_history:
            chat_history_text = chat_history.read()
        chat_history_dialog = ChatHistory(chat_history_text)
